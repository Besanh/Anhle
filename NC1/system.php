...
<?php
    ...
    <?php
        ...
        $result = mysqli_query($con, 'select count(id) as total from system');
        ...
        $sql = "SELECT * FROM `nghia_nhantin`.`system` ORDER BY id ASC LIMIT $start, $limit";
    ?>
    <?php //include_once "xu-ly-system.html" ?>
    <div>
      ...
      <thead style="font-weight:bold; background-color: #1ab188;">
        ...
        <tbody>
            <?php
                //$sql = "SELECT * FROM `nghia_nhantin`.`system` ORDER BY id ASC";
